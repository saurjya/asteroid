...
tag="5sec_lr0001_8b_best_dp_3pat"  # Controls the directory name associated to the experiment
...
#expdir=/data/home/acw497/asteroid/egs/MedleyDB/ConvTasNet/exp/train_convtasnet_22k_4sep_acapella_lr0001
if [[ $stage -le 3 ]]; then
